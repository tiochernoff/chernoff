...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:TIO CHERNOFF\n' // full name
            + 'ORG:Owner Chernoff Bot;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=994407201466:+994 40 720 14 66\n' // WhatsApp ID + phone number
            + 'END:VCARD'
prefix = '!'
blocked = []
limitawal = '999999999'
...
//DATABASE X
			...
			const ownerNumber = ["994407201466@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '994407201466@s.whatsapp.net'
                        const isEventon = isGroup ? event.includes(from) : false
                        const isRegister = checkRegisteredUser(sender)
                        pushname = client.contacts[sender] != undefined ? client.contacts[sender].vname || client.contacts[sender].notify : undefined

                        // Options
                        const botName = 'Chernoff Bot'
                        const ownerName = 'Tio Chernoff'
